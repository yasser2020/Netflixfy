        ...
        <div class="row">
            ...
            <form action="{{ route('login') }}" method="post">
                ...
                <p class="text-center">Create new account<a href="{{route('register')}}"> Register</a></p>
                    ...
                    <hr>
                    <a class="btn btn-block btn-primary"  href="/login/facebook" style="background:#3b5998;">Login by Facebook</a>
                    <a class="btn btn-block btn-primary" href="/login/google" style="background:#ea4335;">Login by Gmail</a>
